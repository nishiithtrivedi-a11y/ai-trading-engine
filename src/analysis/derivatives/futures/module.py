...
Futures-specific features (basis, roll yield, open interest) when fully wired.
...
class FuturesAnalysisModule(BaseAnalysisModule):
    """Futures-specific features (basis, roll yield, open interest). Stub implementation."""
    ...
    def health_check(self) -> dict:
        return {
            ...
            "description": "Futures-specific features (basis, roll yield, open interest). Stub.",
        }
