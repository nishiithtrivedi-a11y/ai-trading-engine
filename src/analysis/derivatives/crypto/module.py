...
Crypto-specific features (on-chain, funding rates, exchange flows) when fully wired.
...
class CryptoAnalysisModule(BaseAnalysisModule):
    """Crypto-specific features (on-chain, funding rates, exchange flows). Stub implementation."""
    ...
    def health_check(self) -> dict:
        return {
            ...
            "description": "Crypto-specific features (on-chain, funding rates, exchange flows). Stub.",
        }
